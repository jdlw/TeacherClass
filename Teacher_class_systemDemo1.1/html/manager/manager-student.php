      ...
      <div id="main-content">
          <div id="sider">
           <ul>
              ...
              <li><a class="a_sider a_now" href="manager-student.php">管理学生</a></li>  
          ...
          <div id="right-text">
            ...
            <div id="re-text">
              ...
              <tbody>
                ...
                <form action="../../php/ma-stu-ac.php" method="post">
                <input placeholder="学号:"  class="re-input" type="text"   name="sno" required="required"/> <span class='state1'>请输入学号</span>
                <input placeholder="密码:"  class="re-input" type="text"   name="spassword" required="required"/> <span class='state1'>请输入密码</span>
