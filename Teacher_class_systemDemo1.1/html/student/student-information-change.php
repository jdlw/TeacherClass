...
<html lang="en">
 ...
 <div id="container">
      <div id="head">
          ...
          <div id="status2">
            ...
            <div id="refer-to-change">
              <a class="btn-recover" href="student-information.php">返回</a>
            </div>
          </div>
      ...
      <div id="main-content">
          <div id="sider">
            <ul>
               <li class="a_sider"><a  class="a_sider" href="student-index.php"  >已选课程</a></li>
          ...
          <div id="right-text">
            ...
            <div id="re-text">
                <form action="../../php/check-info.php" method="post">
