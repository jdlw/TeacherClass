...
<html lang="en">
 ...
 <div id="container">
      ...
      <div id="main-content">
          <div id="sider">
            <ul>
              <li><a class="a_sider" href="department_head_table-index.php">报课情况</a></li>  
          ...
          <div id="right-text">
            ...
            <div id="re-text">
                ...
                <input type="checkbox" name="major[]" value="软件工程" checked="checked"  />软件工程
                </br> </br>
                ...
                <?php
                //$major[10]="解决在te-check-info1中产生问题：major[]数组未定义";
                ?>
