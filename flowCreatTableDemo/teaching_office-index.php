        ...
        <div id="main-content">
          <div id="sider">
            <ul>
              ...
              <li><a class="a_sider" href="teaching_office_table_overview.php">报课情况</a></li>  
          ...
          <div class="table_input_area">
           <form  method="post"  action="../../php/file_input.php"   enctype="multipart/form-data">
            ...
            <label>报课截止日期<label>
              <input type="text" name="user_search"  placeholder="格式:20140101" >
            <label>审核截止日期<label>
              <input type="text" name="user_search"  placeholder="格式:20140101" >  
             </div>  
              ...
              <label>选择对应专业：<label></br></br>
                ...
                <input type="radio" name="file_input" value="tc_math_nor" />数学类
                 ...
                 <input type="radio" name="file_input" value="cb_tc_inf_sec" />信息安全专业（实验班）
                </br> </br>
